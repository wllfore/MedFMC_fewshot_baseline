...
* Secondly, run the script of '**run_fewshot_baseline.sh**' to test the results of Baseline and Meta Baseline method under 1, 5, 10 shot with 10 iterations for each dataset. We have also uploaded the sampled support lists of five datasets corresponding to the reported results in the folder '**list/**' of this repository.
****
## Dataset
